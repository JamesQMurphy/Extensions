...
namespace JamesQMurphy.Extensions
{
    public static class Extensions
    {
        ...
        public static string ToMiniGuid(this Guid guid)
        {
            return guid.ToByteArray().ToBase64UrlString();
        }
        ...
        // Thank you Xav987!
        // https://stackoverflow.com/a/18828085/1001100
